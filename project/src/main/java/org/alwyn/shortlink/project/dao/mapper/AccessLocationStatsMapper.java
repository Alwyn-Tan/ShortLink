...
public interface AccessLocationStatsMapper extends BaseMapper<AccessLocationStatsDO> {
    ...
    @Insert("INSERT INTO access_location_stats_0 (full_short_link, gid, date, access_count, province, city, create_time, update_time, del_flag)" +
            "VALUES(#{accessLocationStats.fullShortLink}, #{accessLocationStats.gid}, #{accessLocationStats.date}, #{accessLocationStats.accessCount}, #{accessLocationStats.province}, #{accessLocationStats.city}, NOW(), NOW(), 0)" +
